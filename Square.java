...
public class Square {
	...
	/**
	 * The empty-argument constructor Square initializes the side variable of the square object to have a length of 0
	 */
	public Square()
	{
		this.side=0;
	...
	/**
	 * @param side, this Square constructor initializes the side variable of the square object to have a length based on the parameter value being passed
	 */
	 ...
	 * 
	 * @paarm area, a local double variable area is used to calculate the value of the area of a given square
	...
	{
		double area  = Math.pow(side,2);
		return ("Side legnth of the sqaure: " + side + " unit(s)\n" + "Area of the Square: " +  area + " square unit(s)\n");
	}//end toString
}
